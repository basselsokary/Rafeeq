...
# ─────────────────────────────────────────────────
CATEGORY_MAP = {
    # ── Exact Excel Type values → clean display name ──────────────────────────
    # Rule: keep the name as close to the Excel value as possible.
    # Only fix spacing/casing issues (DivingSite → Diving Site).
    # Do NOT collapse categories (Religious stays Religious, not "Religious Site").
    "religious":      "Religious",
    "mosque":         "Mosque",
    "church":         "Church",
    "synagogue":      "Synagogue",
