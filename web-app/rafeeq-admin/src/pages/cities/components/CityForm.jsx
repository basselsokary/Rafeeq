...
export default function CityForm({ initial = null, onSubmit, loading, onCancel }) {
  ...
  const hasLocation =
    form.centerLocation.latitude !== '' && form.centerLocation.latitude !== null &&
    form.centerLocation.longitude !== '' && form.centerLocation.longitude !== null &&
    !isNaN(parseFloat(form.centerLocation.latitude)) &&
    !isNaN(parseFloat(form.centerLocation.longitude));
  ...
  return (
    <>
          ...
          >
            ...
            {hasLocation && (
              <span style={{
                ...
                ({parseFloat(form.centerLocation.latitude).toFixed(4)}, {parseFloat(form.centerLocation.longitude).toFixed(4)})
              </span>
            )}
          </button>
      ...
      <LocationPickerModal
        ...
        initial={hasLocation ? form.centerLocation : null}
      />
    </>
  );
}
