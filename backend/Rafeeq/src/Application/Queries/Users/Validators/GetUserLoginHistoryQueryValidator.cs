...
internal sealed class GetUserLoginHistoryQueryValidator : AbstractValidator<GetUserLoginHistoryQuery>
{
    public GetUserLoginHistoryQueryValidator(IErrorLocalizer errors)
    {
        RuleFor(x => x.UserId)
            .NotEmpty()
