...
internal sealed class AddSiteLocalizedContentCommandValidator : AbstractValidator<AddSiteLocalizedContentsCommand>
{
    public AddSiteLocalizedContentCommandValidator(IErrorLocalizer errors)
    {
        RuleFor(x => x.Id)
            .NotEmpty()
        ...
        RuleForEach(x => x.LocalizedContents)
            .SetValidator(new AddSiteLocalizedContentsDtoCommandValidator(errors));
    }
}

internal sealed class AddSiteLocalizedContentsDtoCommandValidator : AbstractValidator<AddSiteLocalizedContentsDtoCommand>
{
    public AddSiteLocalizedContentsDtoCommandValidator(IErrorLocalizer errors)
    {
