...
public sealed class ModeratorUser : StaffUser
{
    ...
    public static Result<ModeratorUser> Create(
        Guid userId,
        string userName,
        string email,
        string firstName,
        ...
        string fullName)
    {
        ...
        return new ModeratorUser(userId, userName, email, firstName, lastName, fullName);
    }
}
