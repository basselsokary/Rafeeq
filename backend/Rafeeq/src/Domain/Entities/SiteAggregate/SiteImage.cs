...
public class SiteImage : BaseAuditableEntity
{
    ...
    private SiteImage() { }
    private SiteImage(Guid storedFileId, StorageKey storageKey, string imageUrl, bool isMain, int displayOrder, string? caption)
    {
    ...
    internal static Result<SiteImage> Create(Guid storedFileId, StorageKey storageKey, string imageUrl, bool isMain, int displayOrder, string? caption)
    {
        ...
        return new SiteImage(storedFileId, storageKey, imageUrl, isMain, displayOrder, caption?.Trim());
    }
